...
export const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, statusJidList }) => {
     ...
     const getButtonType = (message) => {
        // Extrair a mensagem interativa de dentro de viewOnceMessage se existir
        const interactiveMsg = message.viewOnceMessage?.message?.interactiveMessage || message.interactiveMessage;
        ...
        if (
            ...
            interactiveMsg?.nativeFlowMessage ||
            interactiveMsg?.shopStorefrontMessage ||
            interactiveMsg?.collectionMessage ||
            interactiveMsg?.carouselMessage
        ) {
            return [
                {
                    tag: "interactive",
